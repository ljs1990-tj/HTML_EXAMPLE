        ...
        propertyChangedHandler: function (object, key, oldvalue, value) {
            ...
            if (key == "pageSizeMode" || key == "hierarchicalCheckboxes") {
                ...
                if (key == "filterable") {
                    ...
                    that.vScrollBar.jqxScrollBar({ theme: theme });
                    that.hScrollBar.jqxScrollBar({ theme: theme });
                    if (that.pageable && that["pagernexttop"]) {
                        that["pagernexttop"].jqxButton({ theme: theme });
                        that["pagerprevioustop"].jqxButton({ theme: theme });
                        that["pagernextbottom"].jqxButton({ theme: theme });
                        that["pagerpreviousbottom"].jqxButton({ theme: theme });
                        that["pagerfirsttop"].jqxButton({ theme: theme });
                        that["pagerfirstbottom"].jqxButton({ theme: theme });
                        that["pagerlasttop"].jqxButton({ theme: theme });
                        that["pagerlastbottom"].jqxButton({ theme: theme });
                        if (that["pagershowrowscombotop"].jqxDropDownList) {
                            if (that.pagerMode == "advanced") {
                                that["pagershowrowscombotop"].jqxDropDownList({ theme: theme });
                                that["pagershowrowscombobottom"].jqxDropDownList({ theme: theme });
                            }
                        }
                    }
                    if (that.filterable) {
                        ...
                        if (filters.length > 0) {
                            filters.jqxDropDownList({ theme: theme });
                        }
                        if (that.filtercolumnsList) {
                            that.filtercolumnsList.jqxDropDownList({ theme: theme });
                        }
                    }
