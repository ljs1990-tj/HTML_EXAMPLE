...
( function ( $ ) {
    ...
    $.extend( $.jqx._jqxGrid.prototype, {
        ...
        _applyThemeSettings: function () {
            ...
            if ( rowHeight && this.rowsheight === 32 ) {
        ...
        _initmenu: function () {
            ...
            if ( this.host.jqxMenu ) {
                ...
                var filteritem = $( '<li class="filter ' + touchClass + '" style="height: 224px;" ignoretheme="true">' + '<div class="filter"></div>' + '</li>' );
        ...
        _renderprogresscell: function ( me, tablecell, column, row, value ) {
            ...
            if ( $tablecell.find( '.jqx-progress' ).length == 0 ) {
                tablecell.innerHTML = '<progress class="jqx-progress" max="100" style="opacity: 0.99; position: absolute; top: 10%; left: 10%; width:80%; height:80%; padding: 0px;"/>';
                $( tablecell.firstChild ).val( value );
